  ...
  const handleCompleteRequest = async (request) => {
    try {
      const res = await api.patch(
        `/skills/request/${request._id}/complete`
      );
  
      toast.success(
        "🎉 Course completed and transaction processed!"
      );
                      ...
                      .map((r) => (
                        ...
                        >
                          ...
                          {r.requester?._id === user._id &&
                            r.status === "Accepted" && (
                              <button
                                onClick={() => handleCompleteRequest(request)}onClick={() => handleCompleteRequest(request)}
